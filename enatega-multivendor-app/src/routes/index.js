...
import OutletSelection from '../screens/OutletSelection/OutletSelection'
...
function AppContainer() {
  ...
  const handleNotification = useCallback(
    async(response) => {
      ...
      // Removed Apollo fetch logic here.
      // Supabase Realtime channel should handle live updates instead.
  ...
  return (
    <SafeAreaProvider>
      ...
      >
        {!permissionState?.granted || !location ? <LocationStack /> : !outlet ? <OutletNavigator /> : <MainNavigator />}
