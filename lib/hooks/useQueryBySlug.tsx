  ...
  switch (slug) {
    ...
    case "most-ordered-restaurants": {
      ...
      return {
        ...
        fetchMore: async (vars) => {
          const res: any = await mostOrdered.fetchMore({
            variables: { ...vars, shopType: null },
          });
          return (
            res?.data?.mostOrderedRestaurantsPreview ??
            res?.data?.nearByRestaurantsPreview?.restaurants ??
            []
          );
        },
      };
    ...
    case "top-grocery-picks": {
      ...
      return {
        ...
        fetchMore: async (vars) => {
          const res: any = await grocery_pick.fetchMore({
    ...
    case "popular-restaurants": {
      ...
      return {
        ...
        fetchMore: async (vars) => {
          const res: any = await popular_restaurant.fetchMore({
    ...
    case "popular-stores": {
      ...
      return {
        ...
        fetchMore: async (vars) => {
          const res: any = await popular_stores.fetchMore({
            variables: { ...vars, shopType: "grocery" },
          });
          return (
            res?.data?.mostOrderedRestaurantsPreview ??
